      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-hidden">
          ...
          <motion.div
            ...
            style={{ maxWidth }}
            className="w-full max-h-[90vh] flex flex-col theme-card relative z-10 overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-main">
              ...
              <button
                onClick={onClose}
                className="p-2 rounded-lg text-dimmed hover:bg-surface/30 hover:text-main transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
